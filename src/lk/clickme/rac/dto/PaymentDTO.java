...
public class PaymentDTO {
    ...
    public PaymentDTO(int pID, int cID, int rentID, String pMethod, BigDecimal paneltyFee, BigDecimal amount) {
        this.pID = pID;
        this.cID = cID;
        this.rentID = rentID;
    ...
    public String toString() {
        return "PaymentDTO{" + "pID=" + pID + ", cID=" + cID + ", rentID=" + rentID + ", pMethod=" + pMethod + ", paneltyFee=" + paneltyFee + ", amount=" + amount + '}';
    }
