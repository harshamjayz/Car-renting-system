...
public class Rentaldetail {
    ...
    public Rentaldetail(int rentalID, int customerID, int vehicleID, int rentalState, Date rentFrom, Date rentTo) {
    ...
    public String toString() {
        return "Rentaldetail{" + "rentalID=" + rentalID + ", customerID=" + customerID + ", vehicleID=" + vehicleID + ", rentalState=" + rentalState + ", rentFrom=" + rentFrom + ", rentTo=" + rentTo + '}';
    }
